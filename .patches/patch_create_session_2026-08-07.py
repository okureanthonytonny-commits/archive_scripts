...
path = "docs/sessions/session-2026-08-07-summary.md"

new_frag = "# Session summary — 2026-08-07"
if os.path.exists(path):
    with open(path) as f:
        existing = f.read()
    if new_frag in existing:
        print("SKIPPED (session-2026-08-07-summary.md already exists)")
        sys.exit(0)

content = '''# Session summary — 2026-08-07
...
with open(path, "w") as f:
    f.write(content)
print("WRITTEN (session-2026-08-07-summary.md created)")
