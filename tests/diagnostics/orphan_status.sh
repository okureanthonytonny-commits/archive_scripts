...
#
# Original-url reconstruction now shares lib/orphan_reconcile.sh's
# _orphan_derive_url() — the same source of truth the production orphan
# reconciliation uses — replacing the one-off candidate-extension loop
# that lived here before (see issues.md gap 3: .jpg/.jpeg/.png compress
